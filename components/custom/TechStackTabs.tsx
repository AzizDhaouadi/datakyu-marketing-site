// 💅 Chakra UI
import { Text, Heading, Flex, Tabs, List } from "@chakra-ui/react";
...
export default function TechStackTabs({ margin }: TechStackTabProps) {
  return (
    ...
    >
      ...
      <Tabs.Content value="ga4" p={"3"} m={4}>
        ...
        <Flex direction={"column"} gap={2}>
          <Text>
            ...
            migration with precision, rebuilding events and conversions around a
            measurement plan while your business keeps running smoothly.
          </Text>
          <Text>Our services include:</Text>
          <List.Root as="ul" gap={2} mt={2} ml={4} marker="marker">
            <List.Item>
              Zero data loss during transition with parallel tracking validation
            </List.Item>
            <List.Item>
              Smart event architecture mapped from your legacy setup to GA4 best
              practices
            </List.Item>
            <List.Item>
            ...
            <List.Item>
              Complete handover with clear documentation and naming conventions
            </List.Item>
          </List.Root>
        </Flex>
      </Tabs.Content>
      <Tabs.Content value="gtm" p={"3"} m={4}>
        <Heading size={"md"} mb={2}>
      ...
      <Tabs.Content value="amplitude" p={"3"} m={4}>
        <Heading size={"md"} mb={2}>
        ...
        <Flex direction={"column"} gap={2}>
          ...
          <List.Root as="ul" gap={2} mt={2} ml={4} marker="marker">
            <List.Item>
              Unified event schema that makes sense across product and marketing
            </List.Item>
            <List.Item>
            ...
            <List.Item>
              Ready-built dashboards for funnels, retention, user paths, and LTV
            </List.Item>
            <List.Item>
      ...
      <Tabs.Content value="segment" p={"3"} m={4}>
        <Heading size={"md"} mb={2}>
        ...
        <Flex direction={"column"} gap={2}>
          ...
          <List.Root as="ul" gap={2} mt={2} ml={4} marker="marker">
            ...
            <List.Item>
              Smart identity resolution that connects the customer journey dots
            </List.Item>
            <List.Item>
      ...
      <Tabs.Content value="mixpanel" p={"3"} m={4}>
        <Heading size={"md"} mb={2}>
        ...
        <Flex direction={"column"} gap={2}>
          <Text>
            ...
            tells you why it happened and what to do next. We migrate your data
            to unlock the insights that matter.
          </Text>
          <Text></Text>
          <List.Root as="ul" gap={2} mt={2} ml={4} marker="marker">
            <List.Item>
            ...
            <List.Item>
              Quality monitors to catch issues before they corrupt your insights
            </List.Item>
          </List.Root>
        </Flex>
      </Tabs.Content>
