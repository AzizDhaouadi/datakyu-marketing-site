              ...
              return (
                ...
                >
                  <div className="card__header flex justify-between gap-3 relative text-white">
                    <span className="card__label text-base !p-4">
                      {card.label}
                    </span>
                  </div>
                  <div className="card__content flex flex-col relative text-white">
                    <h3
                      className={`card__title font-normal m-0 !p-4 mb-1 !text-2xl !text-white ${
                    ...
                    <p
                      className={`card__description text-xs leading-5 opacity-90 !p-4 ${
